...
* VM 운영 체제는 https://access.redhat.com/articles/4234591#certified[OpenShift Virtualization^]의 게스트 OS로 인증 및 지원되어야 합니다.
...
. 계획 상태가 *'Running'* 으로 바뀌고 , *'Status'* 필드 아래에 회전하는 아이콘이 나타나며 마이그레이션 전체 진행 상황이 표시됩니다.
+
